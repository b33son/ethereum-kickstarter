...
describe('Campaigns', () => {
  ...
  it('allows a contributor to be added to list of approvers', async () => {
  ...
  it('allows a manager can create a SpendRequest', async () => {
    await campaign.methods
      .createRequest('buy batteries', '100', accounts[1])
      .send({ from: accounts[0], gas: '1000000' });
    const request = await campaign.methods.spendRequests(0).call();
  ...
  it('processes requests', async () => {
    ...
    await campaign.methods
      .createRequest('some description text', web3.utils.toWei('5', 'ether'), accounts[1])
      .send({ from: accounts[0], gas: '1000000' });
